    ...
    <div style={{ paddingBottom: 40 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 20, gap: 12 }}>
        ...
        <button
          ...
          style={{ padding: '9px 18px', background: showForm && !editingId ? '#2A2A2A' : '#E81A1A', border: 'none', borderRadius: 8, color: '#fff', fontSize: 13, fontWeight: 700, cursor: 'pointer', flexShrink: 0 }}
